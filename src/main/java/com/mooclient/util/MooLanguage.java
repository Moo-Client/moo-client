    ...
    public static String get(String key) {
        if (current.equals(PL)) {
            return switch (key) {
                ...
                case "emotes_desc" -> "Animacje postaci (np. ręce do góry / Hands Up)";
                case "emotes_opt_title" -> "EMOTKI";
                case "emotes_opt_subtitle" -> "Podnoś ręce w górę i wykonuj gesty postaci.";
                case "keybind_label" -> "Klawisz aktywacji";
                case "press_key_hint" -> "> WCIŚNIJ KLAWISZ <";
                case "mode_hold" -> "Przytrzymaj";
                case "mode_toggle" -> "Przełącz";
            ...
            return switch (key) {
                ...
                case "emotes_desc" -> "Player animations (Hands Up / Surrender)";
                case "emotes_opt_title" -> "EMOTES";
                case "emotes_opt_subtitle" -> "Raise hands up and perform character gestures.";

    ...
    public static String get(String key) {
        ...
        if (PL.equals(current)) {
            return switch (key) {
                ...
                case "keystrokes_name" -> "Keystrokes";
                case "keystrokes_desc" -> "Wyświetla wciśnięte klawisze WSAD oraz Spację w HUD";
                case "keystrokes_opt_title" -> "KEYSTROKES";
                case "keystrokes_opt_subtitle" -> "Wyświetlanie klawiszy ruchu i skoku na ekranie.";
                case "keystrokes_space_mode_label" -> "Wygląd spacji";
                case "keystrokes_show_space_label" -> "Pokaż spację";
                case "keystrokes_space_bar" -> "Pasek (—)";
                case "keystrokes_space_text" -> "Napis (SPACE)";
                ...
                case "itemscale_desc" -> "Powiększanie leżących itemów (Totemy, Koxy, Zbroje) podczas PvP";
                case "itemscale_opt_title" -> "SKALOWANIE PRZEDMIOTÓW";
                case "itemscale_opt_subtitle" -> "Profile powiększania przedmiotów leżących na ziemi";
                case "itemscale_add_profile" -> "+ Dodaj nowy profil";
                case "itemscale_back_to_profiles" -> "← Powrót do profili";
                case "itemscale_edit_btn" -> "EDYTUJ";
                case "itemscale_highlight_scale" -> "Skala wyróżnionych";
                case "itemscale_default_scale" -> "Skala pozostałych";
                case "itemscale_profile_items" -> "Przedmioty w profilu (PPM = wybór enchanta):";
                case "itemscale_quick_add" -> "+ Dodaj szybki przedmiot:";
                case "itemscale_enchant_picker_title" -> "WYBIERZ WYMAGANY ENCHANT";
                case "itemscale_enchant_picker_subtitle" -> "Wymagaj konkretnego zaklęcia na ziemi:";
            ...
            return switch (key) {
                ...
                case "keystrokes_name" -> "Keystrokes";
                case "keystrokes_desc" -> "Displays pressed WASD movement keys and Spacebar on HUD";
                case "keystrokes_opt_title" -> "KEYSTROKES";
                case "keystrokes_opt_subtitle" -> "Movement keys and spacebar HUD display settings.";
                case "keystrokes_space_mode_label" -> "Spacebar style";
                case "keystrokes_show_space_label" -> "Show spacebar";
                case "keystrokes_space_bar" -> "Bar (—)";
                case "keystrokes_space_text" -> "Text (SPACE)";
                case "armor_name" -> "Armor HUD";
                ...
                case "itemscale_desc" -> "Scale up dropped items (Totems, Gapples, Armor) during PvP";
                case "itemscale_opt_title" -> "ITEM SCALE";
                case "itemscale_opt_subtitle" -> "Profiles for scaling dropped items in world";
                case "itemscale_add_profile" -> "+ Add New Profile";
                case "itemscale_back_to_profiles" -> "← Back to Profiles";
                case "itemscale_edit_btn" -> "EDIT";
                case "itemscale_highlight_scale" -> "Highlight Scale";
                case "itemscale_default_scale" -> "Default Scale";
                case "itemscale_profile_items" -> "Profile items (RMB = change enchant):";
                case "itemscale_quick_add" -> "+ Quick add item:";
                case "itemscale_enchant_picker_title" -> "SELECT REQUIRED ENCHANTMENT";
                case "itemscale_enchant_picker_subtitle" -> "Require specific enchantment when dropped:";

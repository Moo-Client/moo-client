    ...
    public static String get(String key) {
        if (current.equals(PL)) {
            return switch (key) {
                ...
                case "emotes_opt_subtitle" -> "Podnoś ręce w górę, wykonuj salta w przód/tył i gesty postaci.";
            ...
            return switch (key) {
                ...
                case "emotes_opt_subtitle" -> "Raise hands up, perform frontflips, backflips and gestures.";
